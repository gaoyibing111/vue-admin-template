<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="所属服务器" min-width="150px">
        <template slot-scope="scope">
      ...
      <el-table-column label="注册时间" width="150px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.dateAdded }}</span>
        </template>
      </el-table-column>
       <el-table-column label="用户语言" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" >{{ scope.row.local }}</span>
        </template>
      </el-table-column>  
      <el-table-column label="用户地区" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type">{{ scope.row.region }}</span>
        </template>
      </el-table-column>  
      
      <el-table-column label="操作" align="center" width="230" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click="getDeviceInfo(scope.row)">查看设备</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { fetchList, fetchUserDevices, fetchPv, createArticle, updateArticle } from '@/api/appUser'
